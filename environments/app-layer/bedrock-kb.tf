...
output "bedrock_kb_security_group_id" {
  description = "Bedrock Knowledge Base security group ID"
  value       = aws_security_group.bedrock_kb.id
}

output "virginia_data_source_id" {
  description = "Virginia S3 data source ID"
  value       = aws_bedrockagent_data_source.virginia_s3.id
}
