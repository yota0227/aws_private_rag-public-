...
global SDC_DIR
set ::DESIGN_NAME tt_trin_disp_eng_noc_niu_router_east
if {![info exists ::tt_global_is_mapped]} { set ::tt_global_is_mapped 1 }
if {![info exists ::DESIGN_NAME]} { set ::DESIGN_NAME {tt_trin_disp_eng_noc_niu_router_east} }
global DESIGN_NAME
...
if {$::DESIGN_NAME eq "tt_trin_disp_eng_noc_niu_router_east"} {
  set_max_fanout 32 [current_design]
