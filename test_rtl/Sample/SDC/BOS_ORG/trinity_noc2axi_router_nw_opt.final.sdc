...
global SDC_DIR
set ::DESIGN_NAME trinity_noc2axi_router_nw_opt
if {![info exists ::tt_global_is_mapped]} { set ::tt_global_is_mapped 1 }
if {![info exists ::DESIGN_NAME]} { set ::DESIGN_NAME {trinity_noc2axi_router_nw_opt} }
global DESIGN_NAME
...
if {$::DESIGN_NAME eq "trinity_noc2axi_router_nw_opt"} {
  set cur_instance {}
  set_max_fanout 32 [current_design]
...
#    Generate collapsed synth reports
  ...
  # pathgroups moved to trinity_noc2axi_router_nw_opt.pathgroups.tcl
}
