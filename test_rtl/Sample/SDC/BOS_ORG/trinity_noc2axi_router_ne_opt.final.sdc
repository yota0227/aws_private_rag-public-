...
global SDC_DIR
set ::DESIGN_NAME trinity_noc2axi_router_ne_opt
if {![info exists ::tt_global_is_mapped]} { set ::tt_global_is_mapped 1 }
if {![info exists ::DESIGN_NAME]} { set ::DESIGN_NAME {trinity_noc2axi_router_ne_opt} }
global DESIGN_NAME
...
#-------------------------------------------------------------------------------
proc isFC {} {
  if {[string match {fc*} [myExecutable]]} { return true }
  return false
}
...
set ::AXICLK_PERIOD         [expr {((1000 / $FREQ_AXI ) * (1 - $CLK_MARGIN)) * $::TIME_SCALE_FROM_PS}]
set ::ck_feedthru_PERIOD    [expr {((1000             ) * (1 - $CLK_MARGIN)) * $::TIME_SCALE_FROM_PS}]
set ::ck_untimed_PERIOD     [expr {((10000.0          ) * (1 - $CLK_MARGIN)) * $::TIME_SCALE_FROM_PS}]
...
set ::vir_AXICLK_PERIOD     [expr {((1000 / $FREQ_AXI ) * (1 - $CLK_MARGIN)) * $::TIME_SCALE_FROM_PS}]
    ###set ::AICLK_PERIOD [expr {699.0 * $::TIME_SCALE_FROM_PS}]
    ###set ::AXICLK_PERIOD [expr {714.0 * $::TIME_SCALE_FROM_PS}]
...
# create_clocks
create_clock -add -name AICLK  -period $::AICLK_PERIOD  [get_ports {noc2axi_i_ai_clk}]
create_clock -add -name NOCCLK -period $::NOCCLK_PERIOD [get_ports {noc2axi_i_nocclk}]
create_clock -add -name OVLCLK -period $::OVLCLK_PERIOD [get_ports {noc2axi_i_dm_clk}]
create_clock -add -name AXICLK -period $::AXICLK_PERIOD [get_ports {noc2axi_i_axiclk}]
...
create_clock -add -name vir_AXICLK -period $::vir_AXICLK_PERIOD
#DONE

set_ideal_network -no_propagate [get_port {noc2axi_i_ai_clk}]
set_ideal_network -no_propagate [get_port {noc2axi_i_dm_clk}]
set_ideal_network -no_propagate [get_port {noc2axi_i_nocclk}]
set_ideal_network -no_propagate [get_port {noc2axi_i_axiclk}]
...
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional input delay of 50% of NOCCLK on *}
  set_input_delay -add_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports 
} else {
  puts {-W- skipping input delay 50% of NOCCLK on *}
}
...
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional output delay of 50% of NOCCLK on *}
  set_output_delay -add_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on *}
}

#set my_ports [remove_from_collection [get_ports -quiet { * } -filter "direction=~in*"] $::my_in_clock_ports]
set my_ports [get_ports $filtered_in_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional input delay of 50% of vir_AXICLK on *}
  set_input_delay -add_delay -max -clock $my_clock  [expr { 50 * $::vir_AXICLK_PERIOD / 100.0 }] $my_ports 
} else {
  puts {-W- skipping input delay 50% of vir_AXICLK on *}
}
...
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional output delay of 50% of vir_AXICLK on *}
  set_output_delay -add_delay -max -clock $my_clock  [expr { 50 * $::vir_AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of vir_AXICLK on *}
}
...
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional input delay of 50% of vir_AICLK on *}
  set_input_delay -add_delay -max -clock $my_clock  [expr { 50 * $::vir_AICLK_PERIOD / 100.0 }] $my_ports 
} else {
  puts {-W- skipping input delay 50% of vir_AICLK on *}
}
...
set my_clock [get_clocks -quiet { vir_AICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional output delay of 50% of vir_AICLK on *}
  set_output_delay -add_delay -max -clock $my_clock  [expr { 50 * $::vir_AICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of vir_AICLK on *}
}
...
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional input delay of 50% of vir_OVLCLK on *}
  set_input_delay -add_delay -max -clock $my_clock  [expr { 50 * $::vir_OVLCLK_PERIOD / 100.0 }] $my_ports 
} else {
  puts {-W- skipping input delay 50% of vir_OVLCLK on *}
}
...
set my_clock [get_clocks -quiet { vir_OVLCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- adding additional output delay of 50% of vir_OVLCLK on *}
  set_output_delay -add_delay -max -clock $my_clock  [expr { 50 * $::vir_OVLCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of vir_OVLCLK on *}
}
### End - Jungyu Im
...
set my_in_ports [get_ports -quiet { * } -filter "direction=~in*"]
set my_out_ports [get_ports -quiet { * } -filter "direction=~*out"]
set my_from_clock [get_clocks -quiet { vir_AXICLK }]
set my_to_clock [get_clocks -quiet { vir_AXICLK }]
...
set my_ports [remove_from_collection [get_ports -quiet { *o_ai_clk } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_ai_clk}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_ai_clk}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_nocclk } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_nocclk}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_nocclk}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_dm_clk } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_dm_clk}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_dm_clk}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_ai_reset_n } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 0% of ck_untimed on i_ai_reset_n}
  set_input_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 0% of ck_untimed on i_ai_reset_n}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_ai_reset_n } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_ai_reset_n}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_ai_reset_n}
}

set my_ports [get_ports -quiet { *i_noc_reset_n } -filter "direction=~in*"]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } { set_multicycle_path -setup 4 -from $my_ports -to $my_clock }

### Jungyu Im : change output port name from o_noc_reset_n to *o_nocclk_reset_n because BOS use trinity_noc2axi_router_ne|nw_opt as top module
set my_ports [remove_from_collection [get_ports -quiet { *o_nocclk_reset_n } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on o_nocclk_reset_n}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on o_nocclk_reset_n}
}

set my_ports [get_ports -quiet { *i_edc_reset_n } -filter "direction=~in*"]
set my_clock [get_clocks -quiet { NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } { set_multicycle_path -setup 4 -from $my_ports -to $my_clock }

set my_ports [get_ports -quiet { *i_powergood }]
...
set my_ports [get_ports -quiet { *o_powergood }]
set my_from_clock [get_clocks -quiet { * }]
set my_to_clock [get_clocks -quiet { * }]
if { [sizeof_collection $my_from_clock]>0 && [sizeof_collection $my_to_clock]>0 && [sizeof_collection $my_ports]>0 } { set_false_path -setup -from $my_from_clock -through $my_ports -to $my_to_clock }

set my_ports [remove_from_collection [get_ports -quiet { *i_dm_uncore_reset_n* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 0% of ck_untimed on i_dm_uncore_reset_n*}
  set_input_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 0% of ck_untimed on i_dm_uncore_reset_n*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_dm_core_reset_n* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 0% of ck_untimed on i_dm_core_reset_n*}
  set_input_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 0% of ck_untimed on i_dm_core_reset_n*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_tensix_reset_n* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 0% of ck_untimed on i_tensix_reset_n*}
  set_input_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 0% of ck_untimed on i_tensix_reset_n*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_dm_uncore_reset_n* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_dm_uncore_reset_n*}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_dm_uncore_reset_n*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_dm_core_reset_n* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_dm_core_reset_n*}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_dm_core_reset_n*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_tensix_reset_n* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { ck_untimed }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 0% of ck_untimed on o_tensix_reset_n*}
  set_output_delay -max -clock $my_clock  [expr { 0 * $::ck_untimed_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 0% of ck_untimed on o_tensix_reset_n*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_psel } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_psel}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_psel}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_penable } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_penable}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_penable}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_pwrite } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_pwrite}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_pwrite}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_pprot* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_pprot*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_pprot*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_paddr* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_paddr*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_paddr*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_pwdata* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_pwdata*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_pwdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_pstrb* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on edc_apb_pstrb*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on edc_apb_pstrb*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_pready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_apb_pready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_apb_pready}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_prdata* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_apb_prdata*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_apb_prdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_apb_pslverr } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_apb_pslverr}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_apb_pslverr}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_fatal_err_irq } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_fatal_err_irq}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_fatal_err_irq}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_crit_err_irq } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_crit_err_irq}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_crit_err_irq}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_cor_err_irq } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_cor_err_irq}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_cor_err_irq}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_pkt_sent_irq } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_pkt_sent_irq}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_pkt_sent_irq}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_pkt_rcvd_irq } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_pkt_rcvd_irq}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_pkt_rcvd_irq}
}

set my_ports [remove_from_collection [get_ports -quiet { loopback_edc_ingress_intf_* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of NOCCLK on loopback_edc_ingress_intf_*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of NOCCLK on loopback_edc_ingress_intf_*}
}

set my_ports [remove_from_collection [get_ports -quiet { edc_egress_intf_* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on edc_egress_intf_*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on edc_egress_intf_*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_reg_psel } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_reg_psel}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_reg_psel}
}

set my_ports [remove_from_collection [get_ports -quiet { i_reg_paddr* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_reg_paddr*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_reg_paddr*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_reg_penable } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_reg_penable}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_reg_penable}
}

set my_ports [remove_from_collection [get_ports -quiet { i_reg_pwrite } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_reg_pwrite}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_reg_pwrite}
}

set my_ports [remove_from_collection [get_ports -quiet { i_reg_pwdata* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_reg_pwdata*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_reg_pwdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_reg_pready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_reg_pready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_reg_pready}
}

set my_ports [remove_from_collection [get_ports -quiet { o_reg_prdata* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_reg_prdata*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_reg_prdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_reg_pslverr } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_reg_pslverr}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_reg_pslverr}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_flit_in_req_south* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 35% of NOCCLK on i_flit_in_req_east*}
  set_input_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 35% of NOCCLK on i_flit_in_req_east*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_flit_in_resp_east* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 35% of NOCCLK on o_flit_in_resp_east*}
  set_output_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 35% of NOCCLK on o_flit_in_resp_east*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_flit_out_req_east* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 35% of NOCCLK on o_flit_out_req_east*}
  set_output_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 35% of NOCCLK on o_flit_out_req_east*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_flit_out_resp_east* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 35% of NOCCLK on i_flit_out_resp_east*}
  set_input_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 35% of NOCCLK on i_flit_out_resp_east*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_flit_in_req_south* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 35% of NOCCLK on i_flit_in_req_south*}
  set_input_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 35% of NOCCLK on i_flit_in_req_south*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_flit_in_resp_south* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 35% of NOCCLK on o_flit_in_resp_south*}
  set_output_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 35% of NOCCLK on o_flit_in_resp_south*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_flit_out_req_south* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 35% of NOCCLK on o_flit_out_req_south*}
  set_output_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 35% of NOCCLK on o_flit_out_req_south*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_flit_out_resp_south* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 35% of NOCCLK on i_flit_out_resp_south*}
  set_input_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 35% of NOCCLK on i_flit_out_resp_south*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_flit_in_req_west* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 35% of NOCCLK on i_flit_in_req_west*}
  set_input_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 35% of NOCCLK on i_flit_in_req_west*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_flit_in_resp_west* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 35% of NOCCLK on o_flit_in_resp_west*}
  set_output_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 35% of NOCCLK on o_flit_in_resp_west*}
}

set my_ports [remove_from_collection [get_ports -quiet { *o_flit_out_req_west* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 35% of NOCCLK on o_flit_out_req_west*}
  set_output_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 35% of NOCCLK on o_flit_out_req_west*}
}

set my_ports [remove_from_collection [get_ports -quiet { *i_flit_out_resp_west* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 35% of NOCCLK on i_flit_out_resp_west*}
  set_input_delay -max -clock $my_clock  [expr { 35 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 35% of NOCCLK on i_flit_out_resp_west*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arid* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arid*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arid*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_araddr* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_araddr*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_araddr*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arcache* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arcache*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arcache*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arprot* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arprot*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arprot*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arburst* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arburst*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arburst*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arlen* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arlen*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arlen*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arsize* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arsize*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arsize*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_aruser* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_aruser*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_aruser*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arlock* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arlock*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arlock*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arqos* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arqos*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arqos*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arregion* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arregion*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arregion*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_arvalid } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_arvalid}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_arvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_arready } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_arready}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_arready}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_rid* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_rid*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_rid*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_rdata* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_rdata*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_rdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_rresp* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_rresp*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_rresp*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_rlast } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_rlast}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_rlast}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_rvalid } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_rvalid}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_rvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_rready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_rready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_rready}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awid* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awid*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awid*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awaddr* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awaddr*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awaddr*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awcache* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awcache*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awcache*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awprot* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awprot*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awprot*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awlock* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awlock*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awlock*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awqos* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awqos*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awqos*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awregion* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awregion*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awregion*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awburst* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awburst*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awburst*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awlen* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awlen*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awlen*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awsize* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awsize*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awsize*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awuser* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awuser*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awuser*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_awvalid } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_awvalid}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_awvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_awready } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_awready}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_awready}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_wdata* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_wdata*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_wdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_wstrb* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_wstrb*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_wstrb*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_wlast } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_wlast}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_wlast}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_wvalid } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_wvalid}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_wvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_wready } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_wready}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_wready}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_bid* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_bid*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_bid*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_bresp* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_bresp*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_bresp*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_noc2axi_bvalid } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_noc2axi_bvalid}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_noc2axi_bvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc2axi_bready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_noc2axi_bready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_noc2axi_bready}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arid* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arid*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arid*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_araddr* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_araddr*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_araddr*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arcache* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arcache*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arcache*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arprot* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arprot*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arprot*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arburst* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arburst*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arburst*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arlen* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arlen*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arlen*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arsize* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arsize*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arsize*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arlock* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arlock*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arlock*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arqos* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arqos*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arqos*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arregion* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arregion*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arregion*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_aruser* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_aruser*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_aruser*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_arvalid } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_arvalid}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_arvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_arready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_arready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_arready}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_rid* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_rid*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_rid*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_rdata* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_rdata*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_rdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_rresp* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_rresp*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_rresp*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_rlast } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_rlast}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_rlast}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_rvalid } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_rvalid}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_rvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_rready } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_rready}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_rready}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awid* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awid*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awid*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awaddr* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awaddr*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awaddr*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awcache* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awcache*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awcache*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awprot* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awprot*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awprot*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awlock* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awlock*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awlock*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awqos* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awqos*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awqos*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awregion* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awregion*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awregion*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awburst* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awburst*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awburst*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awlen* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awlen*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awlen*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awsize* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awsize*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awsize*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awuser* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awuser*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awuser*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_awvalid } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_awvalid}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_awvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_awready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_awready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_awready}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_wdata* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_wdata*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_wdata*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_wstrb* } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_wstrb*}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_wstrb*}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_wlast } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_wlast}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_wlast}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_wvalid } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_wvalid}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_wvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_wready } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_wready}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_wready}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_bid* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_bid*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_bid*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_bresp* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_bresp*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_bresp*}
}

set my_ports [remove_from_collection [get_ports -quiet { o_axi2noc_bvalid } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of AXICLK on o_axi2noc_bvalid}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of AXICLK on o_axi2noc_bvalid}
}

set my_ports [remove_from_collection [get_ports -quiet { i_axi2noc_bready } -filter "direction=~in*"] $::my_in_clock_ports]
set my_clock [get_clocks -quiet { vir_AXICLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting input delay of 50% of AXICLK on i_axi2noc_bready}
  set_input_delay -max -clock $my_clock  [expr { 50 * $::AXICLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping input delay 50% of AXICLK on i_axi2noc_bready}
}

set my_ports [remove_from_collection [get_ports -quiet { o_noc_sec_fence_irq } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 65% of NOCCLK on o_noc_sec_fence_irq}
  set_output_delay -max -clock $my_clock  [expr { 65 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 65% of NOCCLK on o_noc_sec_fence_irq}
}

set my_ports [remove_from_collection [get_ports -quiet { o_mem_shutdown_control* } -filter "direction=~*out"] $::my_out_clock_ports]
set my_clock [get_clocks -quiet { vir_NOCCLK }]
if { [sizeof_collection $my_clock]>0 && [sizeof_collection $my_ports]>0 } {
  puts {-I- setting output delay of 50% of NOCCLK on o_mem_shutdown_control*}
  set_output_delay -max -clock $my_clock  [expr { 50 * $::NOCCLK_PERIOD / 100.0 }] $my_ports
} else {
  puts {-W- skipping output delay 50% of NOCCLK on o_mem_shutdown_control*}
}
...
set my_ports [get_ports -quiet { i_local_nodeid_* }]
set my_from_clock [get_clocks -quiet { * }]
set my_to_clock [get_clocks -quiet { * }]
if { [sizeof_collection $my_from_clock]>0 && [sizeof_collection $my_to_clock]>0 && [sizeof_collection $my_ports]>0 } { set_false_path -setup -from $my_from_clock -through $my_ports -to $my_to_clock }
...
set my_ports [get_ports -quiet { i_mem_config* }]
set my_from_clock [get_clocks -quiet { * }]
set my_to_clock [get_clocks -quiet { * }]
if { [sizeof_collection $my_from_clock]>0 && [sizeof_collection $my_to_clock]>0 && [sizeof_collection $my_ports]>0 } { set_false_path -setup -from $my_from_clock -through $my_ports -to $my_to_clock }

set my_ports [get_ports -quiet { i_test_mode }]
set my_from_clock [get_clocks -quiet { * }]
set my_to_clock [get_clocks -quiet { * }]
if { [sizeof_collection $my_from_clock]>0 && [sizeof_collection $my_to_clock]>0 && [sizeof_collection $my_ports]>0 } { set_false_path -setup -from $my_from_clock -through $my_ports -to $my_to_clock }

set my_ports [get_ports -quiet { i_scan_rst_n }]
set my_from_clock [get_clocks -quiet { * }]
set my_to_clock [get_clocks -quiet { * }]
if { [sizeof_collection $my_from_clock]>0 && [sizeof_collection $my_to_clock]>0 && [sizeof_collection $my_ports]>0 } { set_false_path -setup -from $my_from_clock -through $my_ports -to $my_to_clock }

set my_ports [get_ports -quiet { o_ecc_error* }]
set my_from_clock [get_clocks -quiet { * }]
set my_to_clock [get_clocks -quiet { * }]
if { [sizeof_collection $my_from_clock]>0 && [sizeof_collection $my_to_clock]>0 && [sizeof_collection $my_ports]>0 } { set_false_path -setup -from $my_from_clock -through $my_ports -to $my_to_clock }
...
## clock uncertainties
#set ::AICLK_HOLD_UNCERTAINTY [expr {5 * $::TIME_SCALE_FROM_PS}]
#set ::AICLK_SETUP_UNCERTAINTY [expr {45.485 * $::TIME_SCALE_FROM_PS}]
#set ::AICLK_PHASE_UNCERTAINTY [expr {45.485 * $::TIME_SCALE_FROM_PS}]
#set ::AXICLK_HOLD_UNCERTAINTY [expr {5 * $::TIME_SCALE_FROM_PS}]
#set ::AXICLK_SETUP_UNCERTAINTY [expr {65.71 * $::TIME_SCALE_FROM_PS}]
#set ::AXICLK_PHASE_UNCERTAINTY [expr {65.71 * $::TIME_SCALE_FROM_PS}]
...
#set_clock_uncertainty $::AICLK_PHASE_UNCERTAINTY -rise_from [get_clocks AICLK] -fall_to [get_clocks AICLK]
#set_clock_uncertainty $::AICLK_PHASE_UNCERTAINTY -fall_from [get_clocks AICLK] -rise_to [get_clocks AICLK]
#set_clock_uncertainty -setup $::AXICLK_SETUP_UNCERTAINTY [get_clocks AXICLK]
#set_clock_uncertainty -hold  $::AXICLK_HOLD_UNCERTAINTY  [get_clocks AXICLK]
#set_clock_uncertainty $::AXICLK_PHASE_UNCERTAINTY -rise_from [get_clocks AXICLK] -fall_to [get_clocks AXICLK]
#set_clock_uncertainty $::AXICLK_PHASE_UNCERTAINTY -fall_from [get_clocks AXICLK] -rise_to [get_clocks AXICLK]
...
### Start - Jungyu Im 20250925
# transition limits
set_max_transition -clock_path [expr { 0.1 * $::AICLK_PERIOD }] [get_clocks AICLK]
set_max_transition -data_path  [expr { 0.1 * $::AICLK_PERIOD }] [get_clocks AICLK]
...
set_max_transition -clock_path [expr { 0.1 * $::AXICLK_PERIOD }] [get_clocks AXICLK]
set_max_transition -data_path  [expr { 0.1 * $::AXICLK_PERIOD }] [get_clocks AXICLK]
...
set_max_transition -clock_path [expr { 0.1 * $::ck_untimed_PERIOD }] [get_clocks ck_untimed]
set_max_transition -data_path  [expr { 0.1 * $::ck_untimed_PERIOD }] [get_clocks ck_untimed]
set_max_transition -clock_path [expr { 0.1 * $::vir_AICLK_PERIOD }] [get_clocks vir_AICLK]
set_max_transition -data_path  [expr { 0.1 * $::vir_AICLK_PERIOD }] [get_clocks vir_AICLK]
...
set_max_transition -clock_path [expr { 0.1 * $::vir_AXICLK_PERIOD }] [get_clocks vir_AXICLK]
set_max_transition -data_path  [expr { 0.1 * $::vir_AXICLK_PERIOD }] [get_clocks vir_AXICLK]
### End - Jungyu Im
...
if {$::DESIGN_NAME eq "trinity_noc2axi_router_ne_opt"} {
  set cur_instance {}
  set_max_fanout 32 [current_design]
...
#    Generate collapsed synth reports
  ...
  # pathgroups moved to trinity_noc2axi_router_ne_opt.pathgroups.tcl
}
...
if {[isInnovus]} {
  # Increase the weight and effort level for user created path-groups
  ...
  foreach sin_pg $all_user_cust_pg {
    set_path_group_options [get_object_name [get_path_groups $sin_pg]]  -weight 2 -effort_level high
  }
  set all_user_cust_pg [get_object_name  [get_path_groups {reg2mem mem2reg}]]
  foreach sin_pg $all_user_cust_pg {
...
### multicycle_path at reset port ###
set my_ports [get_ports  { *i_*reset_n } -filter "direction=~in*&&full_name!~*edc*"]
...
### false_path Static Signal
set_false_path -from [get_ports *i_dm_clk] -to [get_ports *o_dm_clk]
set_false_path -from [get_ports *i_ai_clk] -to [get_ports *o_ai_clk]

set_false_path -from [get_ports i_noc_endpoint_id[*]]
set_false_path -from [get_ports i_noc_x_size[*]]
set_false_path -from [get_ports i_noc_y_size[*]]
#set_false_path -from [get_ports i_test_mode]

### Start - PDI - Sanghwi Kim - Relax in/output delay

create_clock -add -name ck_feedthru_AXI -period $::AXICLK_PERIOD

set out_port "o_axi2noc_wready o_axi2noc_awready o_axi2noc_arready"
set in_port  "i_axi2noc_awid* i_axi2noc_awaddr* i_axi2noc_awburst* i_axi2noc_awvalid* i_axi2noc_arid* i_axi2noc_araddr* i_axi2noc_arburst* i_axi2noc_arvalid"

set_input_delay  -add -max -clock ck_feedthru_AXI  [expr { 0  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports $in_port]
set_output_delay -add -max -clock ck_feedthru_AXI  [expr { 40 * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports $out_port]

set_false_path -from [get_clock vir_AXICLK] -through [get_ports $in_port] -to [get_ports $out_port]
set_false_path -from [get_clock ck_feedthru] -through [get_ports $in_port] -to [get_ports $out_port]

set_clock_groups -asynchronous -group [get_clocks ck_feedthru_AXI]

set_input_delay  -max -clock vir_AXICLK  [expr { 30  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_awid*]
set_input_delay  -max -clock vir_AXICLK  [expr { 32  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_arid*]
set_input_delay  -max -clock vir_AXICLK  [expr { 32  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_bready*]
set_input_delay  -max -clock vir_AXICLK  [expr { 31  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_awaddr*]
set_input_delay  -max -clock vir_AXICLK  [expr { 30  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_awburst*]
set_input_delay  -max -clock vir_AXICLK  [expr { 35  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_araddr*]
set_input_delay  -max -clock vir_AXICLK  [expr { 31  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_rready*]
set_input_delay  -max -clock vir_AXICLK  [expr { 29  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_arburst*]
set_input_delay  -max -clock vir_AXICLK  [expr { 40  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports i_axi2noc_awvalid*]

set_output_delay -max -clock vir_AXICLK  [expr {  9  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_wready*]
set_output_delay -max -clock vir_AXICLK  [expr { 10  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_awready*]
set_output_delay -max -clock vir_AXICLK  [expr {  9  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_arready*]
set_output_delay -max -clock vir_AXICLK  [expr { 23  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_rid*]
 
set_output_delay -add -max -clock ck_feedthru_AXI  [expr { 34  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_wready*]
set_output_delay -add -max -clock ck_feedthru_AXI  [expr { 33  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_awready*]
set_output_delay -add -max -clock ck_feedthru_AXI  [expr { 39  * $::vir_AXICLK_PERIOD / 100.0 }] [get_ports o_axi2noc_arready*]

### false_path Static Signal

set_false_path -from [get_ports i_local_nodeid_x[*]]
set_false_path -from [get_ports i_local_nodeid_y[*]]
set_false_path -from [get_ports i_noc_endpoint_id[*]]
set_false_path -from [get_ports i_noc_x_size[*]]
set_false_path -from [get_ports i_noc_y_size[*]]
