...
**Version:** EDC1 v1.1.0 (SUPER=1, MAJOR=1, MINOR=0) — Document V0.2
**Document Status:** V0.2 — RTL-verified corrections applied 2026-03-16
**Date:** 2026-03-16
**Changes from V0.1:**
- §5.4.3.1: Updated FPU/Gtile section with RTL-verified ring order and inst encoding
- §6: Updated Module Hierarchy ring flow diagram to show Gtile[0]→instrn_engine→Gtile[1] order
- §16: Fixed subsection numbering (15.x → 16.x); updated instance paths with correct `gen_x[*].gen_y[*]` hierarchy prefix; added reference to EDC_path_V0.2.md for complete node list
