# Trinity N1B0 — NPU SW Engineer's Complete Guide v0.2
...
- §3  RISC-V Cores — Programming Model
  ...
  - §3.7  Mailbox System
  - §3.8  Boot Sequence and Reset Vector (from overlay_dma §7.2)
  - §3.9  Per-Hart Stack Layout (from overlay_dma §7.3)
  - §3.10 PLIC — Platform-Level Interrupt Controller (from overlay_dma §7.4)
  - §3.11 CLINT — Core-Local Interruptor (from overlay_dma §7.5)
  - §3.12 Fence and Memory Ordering with DMA (from overlay_dma §7.6)
  - §3.13 ROCC Custom Instruction Interface (from overlay_dma §7.7)
  - §3.14 Context Switch Considerations (from overlay_dma §7.8)
  - §3.15 Multi-Hart Coordination Patterns (from overlay_dma §7.9)
...
- §10 Performance Guide — Combined
  ...
  - §10.7 Clock Gating Configuration (from overlay_dma §9.1)
  - §10.8 In-Flight Transaction Depth (from overlay_dma §9.2)
  - §10.9 Backend Selection (from overlay_dma §9.3)
  - §10.10 2D Transfer Efficiency (from overlay_dma §9.4)
  - §10.11 L1 Bandwidth Estimation (from overlay_dma §9.5)
  - §10.12 DRAM Throughput Optimization (from overlay_dma §9.6)
  - §10.13 Latency-Hiding Patterns (from overlay_dma §9.7)
- §11 Debugging Guide (from overlay_dma §10)
- §12 SW Driver Template (from overlay_dma §14)
- §13 LLM Inference Guide — LLaMA 3.1 8B
- §14 INT8 Guide
- §15 VC Channel Guide
- §16 DRAM Address Access Guide
- §17 Appendix
  - §17.1 DFC Format Table (from overlay_dma §11)
  - §17.2 ROCC iDMA Instruction Reference (from overlay_dma §12)
  - §17.3 Address Map Quick Reference (from overlay_dma §13)
  - §17.4 Semaphore Map
...
NOTE: Exact APB byte offsets for iDMA-specific registers are TBD in the RTL and will be documented in a future revision. The register names, reset values, and semantics are fully defined below.
...
*(from overlay_dma_HDD_v0.4 §8.2, §8.3)*
...
*(from overlay_dma_HDD_v0.4 §8.8, §8.9)*
...
*(from overlay_dma_HDD_v0.4 §8.10)*
...
*(from overlay_dma_HDD_v0.4 §8.11)*
...
*(from overlay_dma_HDD_v0.4 §8.12)*
...
*(from overlay_dma_HDD_v0.4 §8.13)*
...
*(from overlay_dma_HDD_v0.4 §8.14)*
...
*(from overlay_dma_HDD_v0.4 §8.15)*
...
This section provides a complete, production-quality C driver template for the Trinity N1B0 iDMA engine. It is intended as a starting point for firmware writers; all TBD addresses must be confirmed against the SoC integration address map.
...
### §17.1 DFC Format Table (from overlay_dma_HDD §11)
...
### §17.2 RISC-V iDMA Instruction Reference (from overlay_dma_HDD §12)
...
### §17.3 Address Map Quick Reference (from overlay_dma_HDD §13)
