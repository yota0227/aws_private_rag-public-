# N1B0 NPU Hardware Design Document v0.98
...
```
┌────────────────────────────────────────────────────────────────────────────────────┐
│                              tt_tensix_with_l1  (one cluster)                      │
│                                                                                    │
│  ┌──────────────────────────────────────────────────────────────┐  ┌────────────┐ │
│  │                      tt_tensix_neo                           │  │tt_t6_l1_   │ │
│  │                                                              │  │partition   │ │
│  │  ┌────────┐  ┌──────────────────┐  ┌──────────────────────┐ │  │            │ │
│  │  │ TRISC3 │  │  TRISC0/1/2      │  │ FPU  ×2 tt_fpu_gtile │ │  │ 512 macros │ │
│  │  │ RV32I  │  │  TRISC0 (pack)   │  │                      │ │  │  = 3 MB    │ │
│  │  │ mgmt   │  │  TRISC1 (unpack) │  │  G-Tile[0] G-Tile[1] │ │  │            │ │
│  │  │        │  │  TRISC2 (math)   │  │  ┌───────┐ ┌───────┐ │ │  │ 512-bit    │ │
│  │  │        │  │                  │  │  │col0..7│ │col0..7│ │ │  │ NoC side   │ │
│  │  │        │  │  semaphore-based │  │  │tt_fpu_│ │tt_fpu_│ │ │  │ channel    │ │
│  │  │        │  │  sync: SEMPOST/  │  │  │mtile  │ │mtile  │ │ │  │            │ │
│  │  └────────┘  │  SEMGET between  │  │  │row0..7│ │row0..7│ │ │  └────────────┘ │
│  │              │  TRISC threads   │  │  │tt_fpu_│ │tt_fpu_│ │ │                 │
│  │              └──────────────────┘  │  │tile   │ │tile   │ │ │                 │
│  │                                    │  │fp_lane│ │fp_lane│ │ │                 │
│  │  ┌──────┐  ┌──────────────────┐   │  │(MACs) │ │(MACs) │ │ │                 │
...
#### 3.7.6 End-to-End DRAM → L1 Data Path: Ports, Burst Length, and Data Rate
...
### 3.8 Standalone NIU Tiles — NOC2AXI_NW_OPT / NOC2AXI_NE_OPT (X=0,X=3 at Y=4)
...
### 7.11 EDC Signal Debugging Guide — Complete Path Tracing
...
#### 7.11.1 Signal Definitions and Properties
...
#### 7.11.2 Forward Path (req_tgl) Signal Propagation
...
#### 7.11.3 Backward Path (ack_tgl) Signal Propagation
...
#### 7.11.4 Complete Per-Node Handshake Sequence
...
#### 7.11.5 Complete Ring Sweep Timeline (End-to-End Example)
...
#### 7.11.6 Proving Points for Waveform Verification
...
#### 7.11.7 RTL Path Mapping for Signal Tracing
...
#### 7.11.7a Trinity Top EDC Signal Hierarchy — Column X=0 (Detailed Signal Listing)
...
#### 7.11.7b Trinity Top EDC Signal Hierarchy — Column X=1 (Composite Tile with Cross-Row Loopback)
...
#### 7.11.8 Debugging Checklist for Failed EDC Sweeps
...
### 12.2a TRISC Instruction Cache (ICache)
...
### 12.2b TRISC Local Memory (LM / Scratchpad)
