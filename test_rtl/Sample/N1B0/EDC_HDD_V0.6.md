...
#### 15.5.1 INIT Counter (`init_cnt`) Detail
...
#### 15.5.2 `async_init` Synchronization Path
...
### C.3 Inter-Node Wiring: `tt_edc_intf_connector`
...
### C.4 Per-Node Clock Assignment (RTL-verified)
...
### C.5 Intra-Module Node-to-Node Wiring (L1 chain example)
